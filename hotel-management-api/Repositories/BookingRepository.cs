...
{
    public class BookingRepository : BaseRespository<Booking>
    {
        private IMapper _mapper;
        public BookingRepository(ApiOption apiConfig, DatabaseContext databaseContext, IMapper mapper) : base(apiConfig, databaseContext)
        {
            this._mapper = mapper;
        }
    }
